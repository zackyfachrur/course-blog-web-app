import FooterLogo from "/Bxaric-Logo.png";

const Footer = () => {
  return (
    <>
      <footer className="flex flex-col items-center justify-center mt-24">
        <div className="bg-[url('/thumbnail/footer-thumb.jpg')] w-[80%] h-[40vh] rounded-xl flex justify-center items-center text-white flex-col drop-shadow-md">
        ...
        <div className="flex justify-around w-full p-24 mt-24 bg-slate-800 item-center">
          {/* Col 1 */}
        ...
        <div className="flex items-center justify-center w-full border-t-2 border-gray-500 bg-slate-800">
